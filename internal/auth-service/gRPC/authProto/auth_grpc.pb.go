...
const (
	AuthService_SignUp_FullMethodName      = "/protobuf.AuthService/SignUp"
	AuthService_Login_FullMethodName       = "/protobuf.AuthService/Login"
	AuthService_ValidateJWT_FullMethodName = "/protobuf.AuthService/ValidateJWT"
)
...
func (c *authServiceClient) ValidateJWT(ctx context.Context, in *JwtRequest, opts ...grpc.CallOption) (*JwtResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(JwtResponse)
...
func (UnimplementedAuthServiceServer) ValidateJWT(context.Context, *JwtRequest) (*JwtResponse, error) {
...
func _AuthService_ValidateJWT_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).ValidateJWT(ctx, req.(*JwtRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "internal/auth-service/gRPC/auth.proto",
}
