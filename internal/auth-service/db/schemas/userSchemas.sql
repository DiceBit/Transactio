...
create index if not exists Users_email_idx on Users using hash (lower(Email));
create index if not exists Users_username_idx on Users using hash (lower(username));
